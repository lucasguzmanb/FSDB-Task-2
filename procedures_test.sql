...
BEGIN
  ...
  fondicu.insert_loan_procedure(p_signature => 'CK239');
...
BEGIN
  fondicu.insert_loan_procedure(p_signature => 'CK238');
EXCEPTION
  WHEN OTHERS THEN
...
INSERT INTO loans VALUES ('CK237', USER, TO_DATE('23-11-2024', 'DD-MM-YYYY'), 'Valsolana', 'Madrid', 'L', 0, TRUNC(SYSDATE) + 14);
BEGIN
  fondicu.insert_loan_procedure(p_signature => 'CK237');
EXCEPTION
  WHEN OTHERS THEN
...
BEGIN
  ...
  fondicu.insert_reservation_procedure(p_isbn => '978-84-8053-584-7', p_date => TO_DATE('23-11-2024', 'DD-MM-YYYY'));
...
BEGIN
  fondicu.insert_reservation_procedure(p_isbn => 'NON_EXISTING_ISBN', p_date => TO_DATE('23-11-2024', 'DD-MM-YYYY'));
EXCEPTION
  WHEN OTHERS THEN
...
BEGIN
  fondicu.record_book_return(p_signature => 'CK237');
...
BEGIN
  ...
  fondicu.record_book_return(p_signature => 'SIG_NON_EXISTING');
EXCEPTION
  WHEN OTHERS THEN
