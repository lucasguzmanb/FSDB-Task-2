CREATE OR REPLACE PACKAGE fondicu AS
    PROCEDURE insert_loan_procedure (p_signature IN CHAR, p_user_id  IN CHAR);
    PROCEDURE insert_reservation_procedure (p_isbn IN VARCHAR2, p_date IN DATE, p_user_id IN CHAR);
    PROCEDURE record_book_return (p_signature IN CHAR, p_user_id IN CHAR);
END fondicu;
/

CREATE OR REPLACE PACKAGE BODY fondicu AS
  PROCEDURE insert_loan_procedure (p_signature IN CHAR, p_user_id  IN CHAR) IS
      v_user_type   CHAR(1);
      v_ban         DATE;
      v_town        VARCHAR2(50);
  ...
  PROCEDURE insert_reservation_procedure (p_isbn IN VARCHAR2, p_date IN DATE, p_user_id IN CHAR) IS
        v_user_type   CHAR(1);
        v_ban         DATE;
        v_town        VARCHAR2(50);
        v_province    VARCHAR2(22);
  ...
  PROCEDURE record_book_return (p_signature IN CHAR, p_user_id IN CHAR) IS
      v_count_users NUMBER;
